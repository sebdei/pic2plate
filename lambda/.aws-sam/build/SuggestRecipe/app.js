...
module.exports.constants = __webpack_require__(/*! ./lib/constants */ "./node_modules/agentkeepalive/lib/constants.js");
...
} = __webpack_require__(/*! ./constants */ "./node_modules/agentkeepalive/lib/constants.js");
...
const handler = (event) => __awaiter(void 0, void 0, void 0, function* () {
    const jsonBody = (event === null || event === void 0 ? void 0 : event.body) && JSON.parse(event.body);
    const imageDataUrl = jsonBody === null || jsonBody === void 0 ? void 0 : jsonBody.image_data_url;
    if (!imageDataUrl) {
    ...
    const gptResponse = yield getGptRecipe(imageDataUrl);
...
function corsHeaders(event) {
    ...
    return {
        ...
        "Access-Control-Allow-Origin": ((_a = event === null || event === void 0 ? void 0 : event.headers) === null || _a === void 0 ? void 0 : _a["Origin"]) || "*",
    };
}
function getGptRecipe(imageDataUrl) {
    var _a, _b, _c;
  ...
  `;
        ...
        return (_c = (_b = (_a = completion === null || completion === void 0 ? void 0 : completion.choices) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.message) === null || _c === void 0 ? void 0 : _c.content;
    });
}
function extractJson(gptResponse) {
    var _a;
    const matches = new RegExp("```json((.|\n)*)```").exec(gptResponse);
    return ((_a = matches === null || matches === void 0 ? void 0 : matches.length) !== null && _a !== void 0 ? _a : 0 >= 2) ? matches === null || matches === void 0 ? void 0 : matches[1] : null;
}
...
function writeError(event) {
    return {
        statusCode: 500,
        headers: Object.assign({ "Content-Type": "text/plain" }, corsHeaders(event)),
        body: JSON.stringify({
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.Blob = void 0;
const web_streams_polyfill_1 = __webpack_require__(/*! web-streams-polyfill */ "./node_modules/formdata-node/node_modules/web-streams-polyfill/dist/ponyfill.js");
...
const isBlob_1 = __webpack_require__(/*! ./isBlob */ "./node_modules/formdata-node/lib/cjs/isBlob.js");
const isFunction_1 = __webpack_require__(/*! ./isFunction */ "./node_modules/formdata-node/lib/cjs/isFunction.js");
...
const node_domexception_1 = __importDefault(__webpack_require__(/*! node-domexception */ "./node_modules/node-domexception/index.js"));
const File_1 = __webpack_require__(/*! ./File */ "./node_modules/formdata-node/lib/cjs/File.js");
const isPlainObject_1 = __importDefault(__webpack_require__(/*! ./isPlainObject */ "./node_modules/formdata-node/lib/cjs/isPlainObject.js"));
__exportStar(__webpack_require__(/*! ./isFile */ "./node_modules/formdata-node/lib/cjs/isFile.js"), exports);
 ...
 * Disclaimer: modules in _shims aren't intended to be imported by SDK users.
 */
__exportStar(__webpack_require__(/*! ../node-runtime.js */ "./node_modules/openai/_shims/node-runtime.js"), exports);
...
const auto = __webpack_require__(/*! openai/_shims/auto/runtime */ "./node_modules/openai/_shims/auto/runtime-node.js");
 ...
 * Disclaimer: modules in _shims aren't intended to be imported by SDK users.
 */
const nf = __importStar(__webpack_require__(/*! node-fetch */ "./node_modules/node-fetch/lib/index.mjs"));
const fd = __importStar(__webpack_require__(/*! formdata-node */ "./node_modules/formdata-node/lib/cjs/index.js"));
const agentkeepalive_1 = __importDefault(__webpack_require__(/*! agentkeepalive */ "./node_modules/agentkeepalive/index.js"));
const abort_controller_1 = __webpack_require__(/*! abort-controller */ "./node_modules/abort-controller/dist/abort-controller.js");
...
const ponyfill_es2018_js_1 = __webpack_require__(/*! web-streams-polyfill/dist/ponyfill.es2018.js */ "./node_modules/web-streams-polyfill/dist/ponyfill.es2018.js");
let fileFromPathWarned = false;
async function fileFromPath(path, ...args) {
    // this import fails in environments that don't handle export maps correctly, like old versions of Jest
    const { fileFromPath: _fileFromPath } = await Promise.resolve().then(() => __importStar(__webpack_require__(/*! formdata-node/file-from-path */ "./node_modules/formdata-node/lib/cjs/fileFromPath.js")));
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/suggest-recipe/app.ts");
